...
export default function PetDisplay({ pet, walletAddress, onAction, onPetUpdate }: PetDisplayProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Pet Visual Card */}
      <div className="relative bg-black/20 backdrop-blur-xl rounded-b-3xl p-4 sm:p-8 border border-white/10 border-t-0 h-[750px] sm:h-[850px] flex flex-col items-center justify-start overflow-hidden">
        {/* Floating Wallet Status Card */}
        {walletAddress && (
          <div className="hidden absolute top-4 left-4 z-10 flex items-center gap-1.5 px-1.5 py-1 bg-black/30 backdrop-blur-xl rounded-xl border border-white/20 shadow-lg">
